        ...
        <div class="tabbed-container">
            <div class="tabbed-head">
                <ul class="nav nav-tabs af-tabs tab-warpper" role="tablist">
                        ...
                        <li class="tab tab-recent <?php echo esc_attr($latest_color_class); ?>">
                            <a href="#<?php echo esc_attr($tab_id); ?>-recent"
                               aria-label="<?php esc_attr_e('Recent', 'morenews'); ?>" role="tab"
                               data-toggle="tab" class="font-family-1 active">
                                <span><i class="fas fa-clock"></i>
                                <?php echo esc_html($latest_title); ?></span>
                            </a>
                        </li>

                        <li role="presentation" class="tab tab-popular <?php echo esc_attr($popular_color_class); ?>">
                            <a href="#<?php echo esc_attr($tab_id); ?>-popular"
                               ...
                               <span> <i class="fas fa-bolt"></i>
                                <?php echo esc_html($popular_title); ?></span>
                            </a>
                        </li>
