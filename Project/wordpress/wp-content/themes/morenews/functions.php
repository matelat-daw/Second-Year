...
function morenews_scripts()
{
    ...
    wp_enqueue_script('bootstrap', get_template_directory_uri() . '/assets/bootstrap/js/bootstrap' . $min . '.js', array('jquery'), $morenews_version, true);
    ...
    wp_enqueue_script('marquee', get_template_directory_uri() . '/assets/marquee/jquery.marquee.js', array('jquery'), $morenews_version, true);
    
    wp_enqueue_script('morenews-script', get_template_directory_uri() . '/assets/script.js', array('jquery'), $morenews_version, true);
