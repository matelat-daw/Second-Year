...
function showItems() // Se Llama a Este Método al abrir la Página.
{
    ...
    for (var i = 0; i < 4; i++)
    {
        html += "<div id='contenedor" + (i + 1) + "' class='inline_grid'><div><img src='" + imgs[i] + "' alt='" + alts[i] + "' class='img'></div><div><div><button id='btn_less" + (i + 1) + "' type='button' class='round' onclick='changeQtty()'>-</button><input id='qtty" + (i + 1) + "' type='number' value='1' onchange='calculate()' required><button id='btn_more" + (i + 1) + "' type='button' class='round' onclick='changeQtty()'>+</button><label id='label" + (i + 1) + "' for='qtty" + (i + 1) + "'>" + items[i] + "</label></div><br><div><input readonly type='number' id='price" + (i + 1) + "' value='" + prices[i] + "' step='.5'><label for='price" + (i + 1) + "'>Precio</label></div><br><div><input readonly type='number' id='total" + (i + 1) + "' step='.5' value='" + prices[i] + "'><label for='total" + (i + 1) + "'>Total</label></div><br><input id='check" + (i + 1) + "' type='checkbox' onchange='invoice()' checked><label for='check" + (i + 1) + "'>Facturar</label>&nbsp;&nbsp;&nbsp;<input id='quit" + (i + 1) + "' type='button' onclick='quit(" + this.id + ")' value='Eliminar' class='danger'></div></div>";
    }
