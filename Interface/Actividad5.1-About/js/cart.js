...
const imgs = ["../media/imgs/fresa.webp", "../media/imgs/limon.webp", "../media/imgs/piña.webp", "../media/imgs/manga.webp"]; // Path a la Imágenes de los Artículos del Carro.
