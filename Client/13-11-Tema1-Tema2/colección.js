...
function coleccionPorCodigo()
{
    ...
    musicos.forEach(musico => {musico.mostrar = function mostrar(){
        let colection = [this.name, this.surname];
...
function guardaEnLocalStorage(clave, coleccion) // Almacena los datos en LocalStorage.
{
...
function mostrarTodo(coleccion)
{
    ...
    console.log(this.musico.join(" - ")); // Muestra por consola el dato deaseado.
}