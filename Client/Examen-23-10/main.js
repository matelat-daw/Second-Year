// import * as projects from "./matelat.js"; // Funciona, Importa Todas.

// const projects = await import ("./matelat.js"); // Funciona, Importa Todas. asynchronous?.
...
(function(){
    // DOM.resutlado1.innerHTML = projects.ejercicio1(programadores); // Este Caso Funciona con los Dos Primeros Imports.

    // DOM.resutlado2.innerHTML = projects.ejercicio2(programadores);

    // DOM.resutlado3.innerHTML = projects.ejercicio3(programadores);

    // DOM.resutlado4.innerHTML = projects.ejercicio4(programadores,4);

    // DOM.resutlado5.innerHTML = projects.ejercicio5(programadores, "Ana");
